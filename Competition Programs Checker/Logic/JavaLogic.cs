    ...
    public static class JavaLogic
    {
        public static string Run(TextBox codeTextBox, TextBox inputTextBox, TextBox outputTextBox, TextBox JavaClassName)
        {
            ...
            try
            {
                ...
                StreamWriter sw = new StreamWriter("C:\\Work\\" + className+".java");
            ...
            try
            {
                ...
                process.StartInfo.Arguments = "/c javac C:\\Work\\Main.java";
                ...
                process.StartInfo.Arguments = "-cp C:\\Work " + className;
                process.StartInfo.CreateNoWindow = false;
